...
class PedigreeQuerySteps
{
    ...
    public String FlNmSequence = "temp/Sequence.tmp";
    public String FlNmFamilies = "temp/Families.tmp";
    public String FlNmFmlGnrtn = "temp/FmlGnrtn.tmp";
    public String FlNmFmlRltns = "temp/FmlRltns.tmp";
    public String FlNmPedigree = "temp/Pedigree.tmp";
    public String FlNmPrsnsXY = "temp/PrsnsXY.tmp";
    public String FlNmLinesXY = "temp/LinesXY.tmp";
...
/*
    private boolean DoStep(int StID)
    {
